...
namespace CodeBase.Infrastructure.Factories
{
    public class HeroFactory : IHeroFactory
    {
        ...
        {
            GameObject hero = _assetProvider.Instantiate(AssetPaths.mannequinTestHeroPath, at: initialPoint.transform.position);
            ConstructHero(hero);
            return hero;
        }
        ...
        private void ConstructHero(GameObject hero)
        {
            ...
            hero.GetComponent<HeroAnimator>().Construct(_inputService, hero.GetComponentInChildren<HeroRotator>());
